...
PATH_CONFIG="/root/lxmproxy/.env"

PATH_NOHUP="/root/lxmproxy/nohup.out"
PATH_ERR="/root/lxmproxy/err.log"
...
installapp() {
    ...
    wget -P $PATH_LX "https://raw.githubusercontent.com/tiancao2022/LXMinerProxy/master/cu.kt" -O "${PATH_LX}/cu.kt" 1>/dev/null
...
echo "-------------------------------------------------------"
colorEcho ${GREEN} "欢迎使用LXMinerProxy安装工具, 请输入操作号继续。"
